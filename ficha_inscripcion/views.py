...
from ficha_inscripcion.serializers import FichaInscripcionSerializer
...
def list_all_fichas_inscripciones(request):
    ...
    serializer = FichaInscripcionSerializer(fichas_inscripciones, many=True)
...
def list_ficha_inscripcion(request, pk):
    ...
    serializer = FichaInscripcionSerializer(ficha_inscripcion, many=False)
    return Response(serializer.data)
